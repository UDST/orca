...
#
# This file automatically deploys changes to http://synthicity.github.io/orca/.
...
if [ "$TRAVIS_REPO_SLUG" == "synthicity/orca" ] && \
        ...
        git clone --quiet --single-branch --branch=gh-pages https://${GH_TOKEN}@github.com/synthicity/orca.git  gh-pages > /dev/null 2>&1
