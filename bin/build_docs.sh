...
#
# This file automatically deploys changes to http://udst.github.io/orca/.
...
if [ "$TRAVIS_REPO_SLUG" == "UDST/orca" ] && \
        ...
        git clone --quiet --single-branch --branch=gh-pages https://${GH_TOKEN}@github.com/UDST/orca.git  gh-pages > /dev/null 2>&1
