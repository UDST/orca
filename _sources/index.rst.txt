...
Orca has explicit goals of flexibility, transparency, lazy execution,
...
`pytest's fixtures <https://docs.pytest.org/en/stable/how-to/fixtures.html>`__.)
...
Orca requires Python 3.10 or later, and depends on Pandas, PyTables, and PyToolz, which will be installed automatically if they are not already present in your Python environment.
...
* `PyPI <https://pypi.org/project/orca/>`__
